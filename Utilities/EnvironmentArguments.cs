    ...
    public static class EnvironmentArguments
    {
        ...
        static EnvironmentArguments()
        {
            if (StartupArguments == null)
            {
                ...
                Domain.LogI($"EnvironmentArguments");
        ...
        public static string GetEnvironmentArgument(string key)
        {
            ...
            if (StartupArguments.ContainsKey(key))
            {
                return StartupArguments[key];
            }
            string keyLower = key.ToLower();
            if (StartupArguments.ContainsKey(keyLower))
            {
                return StartupArguments[keyLower];
            }
